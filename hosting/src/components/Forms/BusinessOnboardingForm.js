...
import { FaBuilding, FaPhone, FaEnvelope, FaGlobe, FaUser, FaBriefcase, FaCreditCard, FaClock, FaAd, FaTruck, FaStar } from 'react-icons/fa';
          ...
          <VStack spacing={6} align="stretch">
            ...
            >
              <Flex align="center" mb={4}>
                <FaAd size="24px" color="#39d2c0" />
                <Heading as="h3" size="md" ml={2} color="#14181b">Digital Marketing</Heading>
              </Flex>
              <Text color="#14181b">
                Boost your online presence with our targeted advertising solutions. 
                We offer customized digital marketing strategies to help your business 
                reach the right audience and grow your customer base.
              </Text>
            </Box>
            ...
            >
              <Flex align="center" mb={4}>
                <FaTruck size="24px" color="#39d2c0" />
                <Heading as="h3" size="md" ml={2} color="# 14181b">Logistics Support</Heading>
              </Flex>
              <Text color="#14181b">
                Streamline your operations with our efficient logistics solutions. 
                From inventory management to delivery services, we provide the tools 
                and support you need to optimize your supply chain.
              </Text>
            </Box>
            ...
            >
              <Flex align="center" mb={4}>
                <FaStar size="24px" color="#39d2c0" />
                <Heading as="h3" size="md" ml={2} color="#14181b">Customer Engagement</Heading>
              </Flex>
              <Text color="#14181b">
                Enhance your customer relationships with our engagement platform. 
                Collect and showcase reviews, manage customer feedback, and build 
                a strong online reputation to attract more business.
              </Text>
            </Box>
          </VStack>
        </GridItem>
