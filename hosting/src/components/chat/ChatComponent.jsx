...
import { addDoc, collection, getFirestore, orderBy, query, onSnapshot, serverTimestamp, updateDoc, doc } from 'firebase/firestore';
  ...
  const sendMessage = async (event) => {
    ...
    try {
      ...
      await updateDoc(chatRef, {
        ...
        last_message_sent_by: currentUser.uid,
        last_message_time: serverTimestamp(),
        last_message_seen_by: [currentUser.uid],
      });
