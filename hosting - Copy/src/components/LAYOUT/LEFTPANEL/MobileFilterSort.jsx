...
import useBusinesses from '@hooks/checkout/useBusinesses'; // Custom Hook to consume BusinessContext

const MobileFilterSort = () => {
  const [isOpen, setIsOpen] = useState(false);
  const { categories, activeCategory, setActiveCategory, handleSort } = useBusinesses();
