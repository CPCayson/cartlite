...
import useBusinesses from '@hooks/checkout/useBusinesses';
import useAppState from '@hooks/useAppState';

/**
 * BusinessList component renders a list or grid of businesses with filtering and sorting options.
 */
const BusinessList = ({ viewType, categories }) => {
